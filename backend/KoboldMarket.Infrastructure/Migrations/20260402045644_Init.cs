    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BuildShares", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BuildShares_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaintProjects", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PaintProjects_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LootEntries_Characters_CharacterId",
                        column: x => x.CharacterId,
                        principalTable: "Characters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LootEntries_Sessions_SessionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BuildShares_UserId",
                table: "BuildShares",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_CampaignMembers_CampaignId_CharacterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LootEntries_CharacterId",
                table: "LootEntries",
                column: "CharacterId");

            migrationBuilder.CreateIndex(
                name: "IX_LootEntries_SessionId",
                table: "LootEntries",
                column: "SessionId");

            migrationBuilder.CreateIndex(
                name: "IX_MarketplaceListings_UserId",
                table: "MarketplaceListings",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_PaintProjects_UserId",
                table: "PaintProjects",
                column: "UserId");
